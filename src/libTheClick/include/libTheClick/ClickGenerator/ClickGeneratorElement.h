...
#ifndef _CLICKGENERATORELEMENT_HEADER_
#define _CLICKGENERATORELEMENT_HEADER_
...
namespace libTheClick
{
    class ClickGeneratorElement
    {
        ...
        //********** ATTRIBUTES **********
        public:
            //! Pointer to ClickGenerator
            ClickGenerator_Interface* cg;
...
#endif // _CLICKGENERATORELEMENT_HEADER_
