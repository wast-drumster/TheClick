...
//    this->speedWidget->setGeometry( QRect(10,10,this->theClickForm->speedGroupBox->width()-20,this->theClickForm->speedGroupBox->height()-20) );
    ...
    this->clickGeneratorScrollListOfWidgets = new ScrollListOfWidgets( this->theClickForm->testGroupBox );
    this->clickGeneratorScrollListOfWidgets->setGeometry( QRect(0,20,this->theClickForm->testGroupBox->width(),this->theClickForm->testGroupBox->height()) );
...
//    this->speedWidget->repaint();
    ...
    this->theClickForm->testGroupBox->setGeometry(10, 0, newWidthClickGeneratorWidgets+20, newHeight-10);
}
